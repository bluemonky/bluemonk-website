...
const FILES = [
  ...
  ['src/data/fde.ts', 'FDEページ（フラッグシップ）', '/fde'],
  ['src/data/services/training-chatgpt.ts', 'ChatGPT研修ページ', '/services/training/chatgpt'],
  ['src/data/services/training-tools.ts', 'Claude / Gemini 研修（ツール別）', '/services/training'],
  ['src/data/services/consulting.ts', 'AXコンサルページ', '/services/consulting'],
  ['src/data/three-cx.ts', '3CX（DXドクトリン・専用ページ）', '/3cx'],
...
const PAGES = [
  ...
  ['src/app/services/training/claude/page.tsx', 'Claude研修', '/services/training/claude'],
  ['src/app/services/training/gemini/page.tsx', 'Gemini研修', '/services/training/gemini'],
  ['src/app/services/consulting/page.tsx', 'コンサルティング', '/services/consulting'],
  ['src/app/3cx/page.tsx', '3CX（DXドクトリン）', '/3cx'],
