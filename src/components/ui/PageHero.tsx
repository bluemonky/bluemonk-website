  ...
  return (
    <section className="relative px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-28">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <h1
          className="hero-in serif-display page-hero-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.25] mb-6 whitespace-pre-line"
