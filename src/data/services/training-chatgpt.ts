...
export const hero = {
  ...
  /** HERO で目立たせる助成金訴求（hero 由来） */
  subsidy: '助成金を活用して実施',
  cta: '無料相談はこちら',
};

// ==========================================================================
// 各セクションの見出し（従来 page.tsx に直書きだった文言を集約）
// ==========================================================================

export const sections = {
  challengesTitle: 'こんな困りごと・課題はありませんか?',
  curriculumTitle: 'カリキュラムと時間割',
  curriculumLead: 'レベルを選んで、講義内容と時間割パターンをご確認いただけます。',
  featuresTitle: 'Blue Monk Consulting の研修の特徴',
  caseStudiesTitle: '研修実績',
  flowTitle: 'サービス導入の流れ',
  instructorTitle: '講師紹介',
  beginnerLabel: '初級編',
  intermediateLabel: '中級編',
};

// ==========================================================================
// 最終 CTA セクション（ダーク「発光する禅」）
// ==========================================================================
...
export const closingCta = {
  ...
  primary: { label: '無料相談はこちら', href: '/contact' },
  secondary: { label: '他の研修プログラムを見る', href: '/services/training' },
};
